...
def vis_res(pred_seq, gt_seq, save_path, input, data_type='vil',
    ...
    if data_type=='vil':
        ...
        input_seq = np.array(input_seq * pixel_scale)
        input_seq = input_seq.astype(np.uint8)

    # pred_seq[pred_seq < 181] = 0
    # gt_seq[gt_seq < 181] = 0
    # input_seq[input_seq < 181] = 0
